...
| 11:00 | <code style="color : SkyBlue">Viable, physical and descriptive models of the early Universe </code> ([Gerbino]()) | <code style="color : SkyBlue">Measurement anchors in the Dark Ages </code> | <code style="color : SkyBlue">New standard ingredients in cosmological analyses</code> | <code style="color : SkyBlue">Review of experiment likelihood frameworks:Euclid </code> ([Martinelli]())|
