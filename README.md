...
| 14:00 | <code style="color : SkyBlue">Treatment of less-known foregrounds </code> ([Cepeda-Arriota]())| <code style="color : SkyBlue">New standard ingredients in cosmological analyses</code> (Alonso TBC)| **<code style="color : Purple">Trip to observatory followed by social dinner</code>**| <code style="color : SkyBlue">Cross-correlation likelihoods, redundancy and use in combined cosmology </code> ([Fabbian]())|
